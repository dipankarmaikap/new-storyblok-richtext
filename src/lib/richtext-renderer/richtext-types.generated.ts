...
// Generated by: pnpm generate-richtext-types
...
export interface TiptapNodeAttributes {
  ...
  image: { src?: string; alt?: string; title?: string | null; width?: number | string | null; height?: number | string | null; id?: string | null; source?: any; copyright?: any; meta_data?: any; };
  emoji: { name?: string | null; emoji?: string | null; fallbackImage?: string | null; };
...
export interface TiptapMarkAttributes {
  link: { href?: string; target?: '_self' | '_blank' | '_parent' | '_top' | null; rel?: string | null; class?: string | null; title?: string | null; linktype?: 'url' | 'story' | 'asset' | 'email'; };
  textStyle: { backgroundColor?: string | null; color?: string | null; fontFamily?: any; fontSize?: any; lineHeight?: any; };
